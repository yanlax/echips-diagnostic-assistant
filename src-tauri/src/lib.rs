...
pub fn run() {
    ...
    let built = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::srv::srv_login,
            commands::srv::srv_ping,
            commands::srv::srv_logout,
            commands::srv::srv_whoami,
            commands::srv::srv_event,
            commands::srv::srv_events,
            commands::srv::techs_list,
            commands::srv::techs_upsert,
            commands::srv::techs_remove,
