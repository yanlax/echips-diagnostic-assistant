...
//   memTestMb         объём проверяемой памяти в автопрогоне, МБ — запрашиваемое
//                     значение, реально урезается до 75% свободной ОЗУ и до
//                     жёсткого потолка 16384 МБ в Rust (run_memory_test) —
//                     ставить сюда с запасом (например 16384), меньшее
//                     значение просто протестирует меньше без всякой пользы
