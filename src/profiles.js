...
//   memTestMb         объём проверяемой памяти в автопрогоне, МБ — реально
//                     урезается до 75% свободной ОЗУ и до жёсткого потолка
//                     16384 МБ в Rust (run_memory_test). Пробовали поднять
//                     по умолчанию до 16384 — тест на полном объёме занимал
//                     слишком много времени для рутинной проверки в
//                     автопрогоне (79 с вместо ~20), вернули 4096; в отчёте
//                     всегда видно, сколько ОЗУ реально установлено против
//                     протестированного объёма
