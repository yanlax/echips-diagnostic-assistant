...
// своя кнопка), как в echips-driver-assistant, но в левом сайдбаре, сразу
// под списком разделов (#theme-toggle-slot), а не поверх рабочей области —
// там она перекрывала кнопки типа «Автопрогон»/«К отчёту» в правом верхнем
// углу экранов (замечание по реальному отчёту). Ниже блока разделов, а не
// в самом низу у подвала — тоже по замечанию пользователя, чтобы не была
// зажата в самом углу. Тема ставится на <html data-theme>
